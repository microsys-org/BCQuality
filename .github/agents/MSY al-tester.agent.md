...
- **With TDD**: Use MSY al-conductor mode (tests first, then implementation)
- **Tests for existing code**: Use MSY al-developer mode (create tests directly)
