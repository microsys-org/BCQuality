...
- `@workspace use MSY al-copilot-capability` - Register new Copilot capability
- `@workspace use MSY al-copilot-promptdialog` - Create PromptDialog page
- `@workspace use MSY al-copilot-prompt-engineer` - Optimize system prompts
- `@workspace use MSY al-copilot-test` - Test Copilot features
...
- **MSY al-conductor**  Implements Copilot feature following this design
- **MSY al-developer**  May adjust/extend Copilot implementation
- **MSY al-tester**  Creates AI Test Toolkit test scenarios
- **MSY al-architect**  May reference for overall architecture
