...
- **Simple fix**: Use MSY al-developer mode (direct implementation)
- **Complex refactor**: Use MSY al-conductor mode (TDD approach)
...
**MSY al-tester reads this**:
- Creates regression tests
- Validates test strategy

**Future MSY al-debugger sessions read this**:
