...
3. .github/plans/*-arch.md → Architectural designs (from MSY al-architect)
...
- **MSY al-conductor** → Creates implementation plan from your findings
- **MSY al-architect** → May reference your research for design decisions
- **MSY al-implement-subagent** → Uses your findings during implementation
- **MSY al-review-subagent** → Validates against patterns you identified
